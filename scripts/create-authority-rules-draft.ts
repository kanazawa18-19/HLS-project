...
const footer: (string | null)[][] = [
  ...
  [
    "決定事項(2026-08-12〜13): 「要確認」に該当するタスクのエスカレーションは、Slackボタン回答" +
      "(承認/差し戻し等)で行う方式に決定。宛先は対象施設の担当ディレクター(不在時はAD)とし、施設マスタの" +
      "director_name/ad_name列で管理する(大型アカウントは「プリンスチーム」「西鉄チーム」のような専属チーム制、" +
      "基本はディレクターが施設と直接やり取りする体制)。損害リスクの高い設定変更(ダブルチェック)の実施記録は、" +
